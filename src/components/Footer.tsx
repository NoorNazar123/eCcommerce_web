          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className=" dark:bg-transparent text-white rounded-l-lg p-2 focus:outline-none w-full"
              />
              <button
                type="submit"
                className="bg-[#FEB47B] dark:bg-black text-white rounded-r-lg px-4 py-2 hover:bg-[#f1f1f1] transition duration-300"
              >
                Subscribe
              </button>
            </form>
